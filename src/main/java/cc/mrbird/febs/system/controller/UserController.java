...
public class UserController extends BaseController {
    ...
    @RequestMapping("find/courseTeachers")
    public FebsResponse deleteUsers() {
        return new FebsResponse().success().data(userService.findByRole(FebsConstant.COURSE_TEACHER_ROLE_ID));
    }
}
